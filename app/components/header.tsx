       ...
       style={{ backgroundImage: "url('/tf2.png')" }}>
        <Shadow />
            ...
            <div className="relative grid grid-cols-1 place-items-center">
                ...
                <p className="lg:mb-20 m-5 text-lg lg:text-3xl text-white text-center"><span className="font-bold">Tattoo</span>, <span className="font-bold">arte</span> e <span className="font-bold">qualidade</span> em um estúdio feito pra quem leva tattoo <span className="font-bold">a sério</span>.</p>
                ...
                <p className="p-3 bg-black/40 text-sm rounded-full m-5 text-white">Bombinhas - Santa Catarina</p>
